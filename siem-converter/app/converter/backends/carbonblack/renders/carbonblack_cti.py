...
from app.converter.backends.carbonblack.const import CARBON_BLACK_QUERY_DETAILS
from app.converter.backends.carbonblack.mappings.carbonblack_cti import DEFAULT_CARBONBLACK_MAPPING
