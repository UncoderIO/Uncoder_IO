...
from app.converter.backends.sigma.models.modifiers import ModifierManager
...
from app.converter.core.operator_types.tokens import GroupType, LogicalOperatorType
