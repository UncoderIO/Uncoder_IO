...
from app.converter.backends.qualys.const import QUALYS_QUERY_DETAILS
from app.converter.backends.qualys.mappings.qualys_cti import DEFAULT_QUALYS_MAPPING
