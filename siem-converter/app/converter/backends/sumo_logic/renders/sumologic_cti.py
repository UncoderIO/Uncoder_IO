...
from app.converter.backends.sumo_logic.const import SUMO_LOGIC_QUERY_DETAILS
from app.converter.backends.sumo_logic.mappings.sumologic_cti import DEFAULT_SUMOLOGIC_MAPPING
