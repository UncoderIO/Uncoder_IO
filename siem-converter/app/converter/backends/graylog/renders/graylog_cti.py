...
from app.converter.backends.graylog.const import GRAYLOG_QUERY_DETAILS
from app.converter.backends.graylog.mappings.graylog_cti import DEFAULT_GRAYLOG_MAPPING
