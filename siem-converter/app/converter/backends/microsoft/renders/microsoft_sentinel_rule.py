...
from app.converter.backends.microsoft.renders.microsoft_sentinel import (
    MicrosoftSentinelQueryRender,
    MicrosoftSentinelFieldValue
)
from app.converter.backends.microsoft.const import DEFAULT_MICROSOFT_SENTINEL_RULE, microsoft_sentinel_rule_details
