...
from app.converter.backends.snowflake.const import SNOWFLAKE_QUERY_DETAILS
from app.converter.backends.snowflake.mappings.snowflake_cti import DEFAULT_SNOWFLAKE_MAPPING
