...
class ChronicleFieldValue(BaseQueryFieldValue):
    ...
    def clean_str_value(self, value: str) -> str:
        if value.endswith("/"):
            value = value.rstrip("/")
        return value
    ...
    def equal_modifier(self, field: str, value: DEFAULT_VALUE_TYPE) -> str:
        ...
        return f'{self.apply_field(field)} = "{self.apply_value(value)}" nocase'
    ...
    def regex_modifier(self, field: str, value: DEFAULT_VALUE_TYPE) -> str:
        ...
        return f'{self.apply_field(field)} = /{self.apply_asterics_value(value)}/ nocase'
